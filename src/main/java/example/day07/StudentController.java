...
// @Component : 스프링 컨테이너(메모리)에 빈(객체) 등록/생섬 , 싱글톤 역할
...
public class StudentController {
    ...
    // ("/URL") : HTTP 주소 만들기/정의 , localhost:8080/student/save
    public boolean save( @RequestBody StudentDto studentDto ){
        System.out.println("StudentController.save"); // s out m
        System.out.println("studentDto = " + studentDto); // s out p
        // -- DAO
