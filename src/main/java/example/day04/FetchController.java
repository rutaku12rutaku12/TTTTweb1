...
public class FetchController {
    ...
    public void method1(){System.out.println("FetchController.method1"); // s out m
    } // method end
    ...
    // localhost:8080/day04/exam5?name=유재석&age=10
    // response : 200 , true
    ...
    public boolean method5( @RequestParam String name ,@RequestParam int age){
        ...
        System.out.println("result = " + result); // s out v  가장 가까운 지역변수 출력
        return result;
    }
    ...
    // 7.
    // request : http://localhost:8080/day04/exam7 , body : { "name" : "유재석" , "age" : "40" }
    ...
    public List<TaskDto> mehthod8(@RequestParam String name , int age ){
        System.out.println("FetchController.mehthod8");
        System.out.println("name = " + name + ", age = " + age);
